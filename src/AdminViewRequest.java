 ...
 */
public class AdminViewRequest extends javax.swing.JFrame {

    /**
     * Creates new form AdminViewRequest
     */
    Connection con = null;
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "BookName", "Author", "Email", "Address", "Mobile Number"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminViewRequest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminViewRequest().setVisible(true);
            }
        });
    }
    ...
    private void Search(){
        ...
        if(search.getText().equals("")){
            ...
            String query="select * from bookRequests ";
            ...
            String query="select * from bookRequests where bookName=?";
