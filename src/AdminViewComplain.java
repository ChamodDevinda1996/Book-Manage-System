 ...
 */
public class AdminViewComplain extends javax.swing.JFrame {

    /**
     * Creates new form AdminViewComplain
     */
    Connection con = null;
    PreparedStatement ps = null;
    ResultSet rs = null;
   
    public AdminViewComplain() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "User Name", "Complain", "Email", "Address", "Mobile Number"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminViewComplain.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminViewComplain().setVisible(true);
            }
        });
    }
    ...
    private void Search(){
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    String Author = rs.getString("complain");
                    String Year = rs.getString("email");
                    String Idnumber = rs.getString("address");
         ...
         private void Search(String Search){
            ...
            String query="select * from complain where name=?";
