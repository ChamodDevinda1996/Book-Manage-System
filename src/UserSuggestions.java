 ...
 */
public class UserSuggestions extends javax.swing.JFrame {

    /**
     * Creates new form UserSuggestions
     */
    Connection con = null;
...
private  void insert(String userName,String suggestion,String email,String address,String mobileNo){
        
    
    try {

        String sql = "INSERT INTO suggestion(name,suggestion,email,address,mobileNum) VALUES(?,?,?,?,?)";
        ...
        ps.execute();
        ps.close();
        //Joptionpane.showmesssage  ctrl+space
    ...
    private void initComponents() {
        ...
        jLabel2.setText("User Suggestions");
        ...
        mobilenum.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
        ...
        jLabel11.setText("We are truly thankful for the time that are you taking to make");

        jLabel12.setFont(new java.awt.Font("Tahoma", 0, 20)); // NOI18N
        jLabel12.setText("suggestions.we'll make sure that your suggestion is definitely");
        ...
        jLabel15.setText("taken into consideration in next software upgrade.");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String suggestion = this.jTextArea1.getText();
        String email = this. email.getText();
        String address = this.address.getText();
        String mobileNum = mobilenum.getText();

        insert(username, suggestion, email, address, mobileNum);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserSuggestions.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UserSuggestions().setVisible(true);
            }
        });
    }
