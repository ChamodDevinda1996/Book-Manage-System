 ...
 */
public class UserRequestNewBook extends javax.swing.JFrame {

    /**
     * Creates new form RequestNewBook
     */
    Connection con = null;
    ...
    public UserRequestNewBook() {
        ...
        if (UserDetails.loggedin) {
            ...
            jLabel13.setText(UserDetails.username);
    ...
    private  void insert(String bookName,String Author,String email,String address,String mobileNo){
        
    
    try {

        String sql = "INSERT INTO bookRequests(bookName,Author,email,address,mobileNumber) VALUES(?,?,?,?,?)";
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Request New Book");
        ...
        jLabel11.setText("We'll let you know as soon as the requested book is availabel");

        jLabel12.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        jLabel12.setText("through the provided means of contact.");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String password = this.username1.getText();
        String email = this. email.getText();
        
        String address = this.address.getText();
        String mobileNum = mobilenum.getText();

        insert(username, password, email, address, mobileNum);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserRequestNewBook.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UserRequestNewBook().setVisible(true);
            }
        });
    }
