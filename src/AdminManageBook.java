 ...
 */
public class AdminManageBook extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Book Name", "Authur", "Year", "ID Number", "Price"
            }
        ) {
    ...
    private void jToggleButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton7ActionPerformed
        ...
        if (Search.equalsIgnoreCase("")) {
            ...
            HelperFuctions ob=new HelperFuctions();
            ob.BookSearch(jTable1,Search,SearchOption);
    ...
    private void jToggleButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton8ActionPerformed
        ...
        try {
             price = Long.parseLong(jTextField6.getText());
             year = Long.parseLong(jTextField3.getText());
             valid =true;
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Please enter a number for price field and Year field");
            
        }
        
        if (id.equalsIgnoreCase("")) {
            JOptionPane.showMessageDialog(null, "Id number field must be filled!!!");
        }
        else if(valid){
        String query="UPDATE books SET BookName=?, Author=?, Year = ?, Price= ? Where Idnumber =?";
    ...
    private void jToggleButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton9ActionPerformed
        // TODO add your handling code here:
        try{
            String sql = "DELETE FROM books WHERE Idnumber = ?";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminManageBook.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminManageBook().setVisible(true);
            }
        });
    }
